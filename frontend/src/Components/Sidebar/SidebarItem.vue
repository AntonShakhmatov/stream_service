  ...
  <Link
    ...
    :class="[
      active
        ...
        : 'text-gray-600 hover:bg-gradient-to-r text-white',
      'group/link flex items-center rounded-md px-1 py-2 text-base font-medium transition-colors from-cyan-500 to-blue-500',
    ]"
  >
    <component
      :is="icon"
