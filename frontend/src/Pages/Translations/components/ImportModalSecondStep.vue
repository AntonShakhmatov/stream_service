<template>
  <form>
    <div class="text-sm font-medium text-gray-700">
      <p>
        {{
          $t("mycustomadmin", "Found: :found / For review: :toReview", {
    ...
    <table class="border-separate border-spacing-3 border-gray-500">
      <thead>
        <tr>
          <th>{{ $t("mycustomadmin", "Group") }}</th>
          <th>{{ $t("mycustomadmin", "Default") }}</th>
          <th>{{ $t("mycustomadmin", "Current value") }}</th>
          <th>{{ $t("mycustomadmin", "Imported value") }}</th>
